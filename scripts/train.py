...
def main():
    ...
    metrics = train_continuous(
        ...
        loss_ce_weight=train_cfg.loss_ce_weight,
        loss_mtp_weight=train_cfg.loss_mtp_weight,
        loss_contrastive_weight=train_cfg.loss_contrastive_weight,
        loss_distill_weight=train_cfg.loss_distill_weight,
        logit_clip=train_cfg.logit_clip,
    )
